			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 svbb pb-3">
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12 col-md-4 col-sm-6 col-6 mt-3">
							<?php
								if($showrs['shop_pic'] != ''){
							?>
						...
						<div class="col-12 mt-2">
							<div class="row">
								<div class="col-xl-12 col-lg-12 col-md-4 col-sm-3 col-3"></div>
								<div class="col-xl-12 col-lg-12 col-md-4 col-sm-6 col-6">
