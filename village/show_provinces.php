...
?>
 ...
 <div class="col-md-12">
	 <div class="row">
		 <div class="col-md-6">
		 	<a class="text-light" href="admin_index.php?url=add_provinces.php"><button type="button" class="btn btn-dark mt-3 mb-3">เพิ่มข้อมูล</button></a>
		 </div>
 	 <?php
...
<?php
   if($_POST){
		...
		$rs = $db->specifytable('*','provinces',"name_in_thai LIKE '%{$search}%'")->execute();
			$grid = new gridView();
			$grid->pr = 'id';
