<head>
 ...
 <div class="col-md-12">
<?php
    $columns = array('shop_name','shop_detail','shop_open','shop_close','shop_ratepricemin','shop_ratepricemax','member_username');
    $rs = $db->findByPK2('shop','member','shop.member_member_id','member.member_id')->execute();

			$grid = new gridView();
			$grid->pr = 'shop_id';
			$grid->header = array('<b><center>ชื่อร้านค้า</center></b>','<b><center>รายละเอียดร้าน</center></b>','<b><center>เวลาเปิด</center></b>','<b><center>เวลาปิด</center></b>','<b><center>เรทราคาต่ำสุดของร้าน</center></b>','<b><center>เรทราคาสูงสุดของร้าน</center></b>','<b><center>ชื่อเจ้าของร้าน</center></b>','<b><center>#</center></b>');
