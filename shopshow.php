...
<?php
	...
	if($keyword != ''){
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
				<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12 mt-3 br3">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
						<div class="row">
				...
				?>
				<div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 mt-3 br3">
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
							<div id="shop_name<?php echo $i;?>" class="shop_name"><?php echo $showtype['shop_name'];?></div>
						</div>
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<?php
							...
							$memberrate = $rsselect['COUNT(member_member_id)'];
							$avgrate = ($rate/$memberrate); ?>
							<div class="col-md-10 lg6 pl-0" id="rate<?php echo $i;?>" class="starrate">
								<input type="hidden" id="shop_id" value="<?php echo $showrs['shop_id'];?>">
								<input type="hidden" id="avg_rating" value="<?php echo $avgrate;?>">
							</div>
						</div>
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="row">
								...
								<div class="col-xl-9 col-lg-8 col-md-7 col-sm-8 col-4">
									...
									?>
										<img class="d-block w-100" height="110" src="images/shop/<?php echo $showtype['shop_pic']; ?>">
									<?php }else{ ?>
										<img class="d-block w-100" height="110" src="images/noimage.png">
									<?php
									}
									?>
								</div>
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-8">
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 pl-0 pr-0 pb-3">
